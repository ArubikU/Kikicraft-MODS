ServerEvents.recipes(e => {
    ...
    let ore="zinc"
    let output="create:crushed_raw_zinc"
    ...
    e.recipes.create.milling(['moremekanismprocessing:dirty_dust_'+ ore,
         ...
         e.recipes.create.milling([Item.of('moremekanismprocessing:dirty_dust_'+ ore).withChance(0.35),
            Item.of('moremekanismprocessing:crystal_'+ ore).withChance(0.15), Item.of('create:experience_nugget').withChance(0.1)], "#create:stone_types/asurine")
    e.recipes.create.milling(['moremekanismprocessing:dirty_dust_'+ ore,
