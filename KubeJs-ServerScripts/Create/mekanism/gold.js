ServerEvents.recipes(e => {
    ...
    let ore="gold"
    let output="create:crushed_raw_gold"
    ...
    e.recipes.create.milling(['mekanism:dirty_dust_'+ ore,
         ...
         e.recipes.create.milling([Item.of('mekanism:dirty_dust_'+ ore).withChance(0.35),
            Item.of('mekanism:crystal_'+ ore).withChance(0.15), Item.of('create:experience_nugget').withChance(0.1)], "#create:stone_types/ochrum")
    e.recipes.create.milling(['mekanism:dirty_dust_'+ ore,
